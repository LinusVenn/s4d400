...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD ValidateCustomer.
    ...
    DATA travels TYPE TABLE FOR READ RESULT ZR_19_TravelTP.
    " Read Travels

    READ ENTITIES OF ZR_19_TravelTP IN LOCAL MODE
         ENTITY Travel
         FIELDS ( CustomerId )
  ...
  METHOD DetermineStatus.
    DATA travels TYPE TABLE FOR UPDATE zr_19_travelTP.
    ...
    MODIFY ENTITIES OF ZR_19_TravelTP IN LOCAL MODE
           ENTITY Travel
           UPDATE
           FIELDS ( Status )
           WITH travels.
